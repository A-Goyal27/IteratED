class Tutor:
    def __init__(self, question="", answer="", verificationMode=False, logLength=2): #there will be a new tutor for each question
        ...
        self._initPrompt = self._openFile("../Prompts/InitPrompt.txt")
        ...
        self._verificationPrompt = self._openFile("../Prompts/verificationModePrompt.txt")
    ...
    def _summarizeHistory(self, chatHistory):
        contents = self._openFile("../Prompts/summaryPrompt.txt")
